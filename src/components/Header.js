    ...
    <nav className="font-bold flex flex-col h-18 shadow-gray-light shadow-sm justify-between md:flex-row md:items-center">
      <div className="flex flex-row justify-between items-center">
        <div className="flex flex-row items-center">
          ...
          <p className="font-bold text-2xl text-orange-700 text-opacity-90 from-neutral-400 md:text-3xl">
            Swiggy
          </p>
        </div>
        <div
          className="md:hidden px-3 cursor-pointer"
          onClick={() => {
            toggelMenu();
          }}
        >
          {isMenuOpen ? <RxCross2 /> : <TiThMenu />}
        </div>
      </div>
